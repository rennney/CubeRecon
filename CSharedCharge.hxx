#ifndef CSharedCharge_hxx_seen
#define CSharedCharge_hxx_seen
...
void CSharedCharge(std::string file2D = "../FileWith2DHits.root",
    ...
    Attach2D(file2D);
    Attach3D(file3D);
    AttachOutput(fileOut);
#endif

#define UseInsideStructure
#ifdef UseInsideStructure
    ...
    gOutputFile = new TFile(fileOut.c_str(),"RECREATE");
    gOutputTree = new TTree("treeWith3DHits",
                            "tree with 3D hits (w/ shared deposits)");
